Always update the chat.md file with the prompts and repsonses keep appending it remove the earlier chat history of 4 hours before to keep the chat file small and add a time stamp for every prompt so you can delete the previous history
